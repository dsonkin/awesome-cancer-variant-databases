...
- [ClinVar](https://www.ncbi.nlm.nih.gov/clinvar) - Most of variants in ClinVar are germline, however increasing number of new variants are somatic. ClinVar provides extensive and comprehensive pathogenicity interpretation for germline variants in many genes including hereditary cancer genes, such variants are also frequently found as somatic in sporadic malignancies. Variants pathogenicity interpretations in ClinVar submitted by ClinGen approved expert panels are officially recognized by [FDA as valid scientific evidence](https://www.fda.gov/downloads/MedicalDevices/ProductsandMedicalProcedures/InVitroDiagnostics/PrecisionMedicine-MedicalDevices/UCM627510.pdf). ["Web app", "Download"]
