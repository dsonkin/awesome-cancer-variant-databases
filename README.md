...
- [ClinGen Evidence Repository](https://erepo.clinicalgenome.org/evrepo) - ClinGen Evidence Repository is intended to provide access to variant level evidence used and applied by ClinGen Variant Curation Expert Panels in the classification of variants. At this point variants in repository are germline, however genes in this resource also include hereditary cancer genes, and variants in such genes are also frequently found as somatic in sporadic malignancies. Variants pathogenicity interpretations submitted by ClinGen approved expert panels are officially recognized by [FDA as valid scientific evidence](https://www.fda.gov/downloads/MedicalDevices/ProductsandMedicalProcedures/InVitroDiagnostics/PrecisionMedicine-MedicalDevices/UCM627510.pdf). [API, Web app]
